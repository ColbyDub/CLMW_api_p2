package com.revature.teamManager.web.filters;

import com.revature.teamManager.web.dtos.Principal;
import com.revature.teamManager.web.util.security.JwtConfig;
    ...
    public void parseToken(HttpServletRequest req) {
        ...
        try {
            ...
            if (header == null || !header.startsWith(jwtConfig.getPrefix())) {
                ...
                //logger.warn("Request originates from an unauthenticated source.");        //TODO logger here
                return;
            }
